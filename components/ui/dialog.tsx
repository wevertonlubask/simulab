...
// Versão do DialogContent sem transform - para uso com drag and drop
const DialogContentNoTransform = React.forwardRef<
  React.ElementRef<typeof DialogPrimitive.Content>,
  DialogContentProps
>(({ className, children, hideCloseButton, ...props }, ref) => (
  <DialogPortal>
...
DialogContentNoTransform.displayName = "DialogContentNoTransform";
